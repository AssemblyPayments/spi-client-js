        ...
        switch (state.ConnectionState)
        {
            ...
            case ConnectionState.Disconnected:
                ...
                if (this.CurrentStatus != SpiStatus.Unpaired)
                {
                    ...
                    if (this.CurrentTxFlowState.Type === TransactionType.Reversal)
                    {
                        this.CurrentTxFlowState.Completed(Message.SuccessState.Failed, null, "We were in the middle of a reversal when a disconnection happened, let's fail the reversal.");
                        this._eventBus.dispatchEvent(new CustomEvent('TxFlowStateChanged', { detail: this.CurrentTxFlowState }));
                    }
