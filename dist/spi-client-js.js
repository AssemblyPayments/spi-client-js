...
var DeviceIpAddressRequest = function DeviceIpAddressRequest() {
    _classCallCheck(this, DeviceIpAddressRequest);
...
var DeviceIpAddressService = function () {
...
var Spi = function () {
    ...
    _createClass(Spi, [{
        ...
        value: function ResolveDeviceIpAddress() {
            ...
            service.RetrieveService(this._serialNumber, this._deviceApiKey).then(function (ip) {
                if (ip && ip.Ip) {
                    _this6.CurrentDeviceStatus = new DeviceIpAddressStatus(ip.Ip, ip.Last_updated);
                }
                document.dispatchEvent(new CustomEvent('DeviceIpChanged', { detail: _this6.CurrentDeviceStatus }));
            });
        }
    }], [{
        key: 'GetVersion',
