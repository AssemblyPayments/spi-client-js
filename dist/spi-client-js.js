...
(function (global, factory) {
    ...
    var Spi = function () {
        ...
        _createClass(Spi, [{
            ...
            value: function InitiatePurchaseTxV2(posRefId, purchaseAmount, tipAmount, cashoutAmount, surchargeAmount, promptForCashout, options) {
            ...
            value: function InitiateRefundTx(posRefId, amountCents, isSuppressMerchantPassword) {
                if (this.CurrentStatus == SpiStatus.Unpaired) {
                    return new InitiateTxResult(false, "Not Paired");
                }
            ...
            value: function InitiateCashoutOnlyTx(posRefId, amountCents, surchargeAmount) {
                if (this.CurrentStatus == SpiStatus.Unpaired) return new InitiateTxResult(false, "Not Paired");
            ...
            value: function InitiateMotoPurchaseTx(posRefId, amountCents, surchargeAmount) {
                if (this.CurrentStatus == SpiStatus.Unpaired) return new InitiateTxResult(false, "Not Paired");
